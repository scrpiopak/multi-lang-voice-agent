...
(4) Package requirements python = 3.11 fastapi>=0.136.1 groq>=1.2.0 python-dotenv>=1.2.2 python-multipart>=0.0.26 uvicorn>=0.46.0

(5) vs code and uv is used for this project uv init voice-agent cd voice-agent uv add fastapi uvicorn python-dotenv groq uv run uvicorn app.main:app --reload --port 8000